var ChatBot = function () {
    ...
    return {
            ...
            SAP: () => {
                ...
                return {
                        ...
                        fetch(requestURL, requestInfo)
                            ...
                            .then(data => {
                                ...
                                data.results.messages.forEach(message => {
                                    ChatBot.addChatEntry(message.content, "bot");
                                })
                    ...
                    init: () => {
                        ...
                        const clientid = "sb-790f46bd-7335-4018-9a8d-3c9ee0a77099-CLONE-RT!b40741|cai-production!b20881";
                        const secret = "vFab9NkTiAfaUCNoduDSZGnd6FE=";
        ...
        init: function (options) {
            ...
            inputDom = document.querySelector(inputs);

            // update the command description
            updateCommandDescription();

            const initPromises = engines.map(engine => engine.init());
